...
let c = fs.readFileSync('apps/api/src/modules/storage/storage.controller.ts', 'utf8');
...
let s = fs.readFileSync('apps/api/src/modules/storage/storage.service.ts', 'utf8');

...
export async function developersRoutes(app: FastifyInstance) {
  ...
  app.get(
    '/me/apps/:appId/analytics',
    { preHandler: [authenticateRequest, requireRole('developer')] },
    controller.getAppAnalytics as any,
  );
  app.get(
    '/me/apps/:appId/analytics/realtime',
    { preHandler: [authenticateRequest, requireRole('developer')] },
    controller.getAppAnalyticsRealtime as any,
  );
}
